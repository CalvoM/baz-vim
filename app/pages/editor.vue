  ...
  <div class="editor-page">
    ...
    <section class="editor-wrap">
      ...
      <div class="status-bar">
        <span class="vim-mode" :class="vim_editor.vimModeClass">{{
          vim_editor.vimModeLabel
        }}</span>
        <span class="status-sep">│</span>
        <span class="cursor-pos"
          >{{ editor_stats.currentLineNum }}:{{
            editor_stats.currentColNum
          }}</span
        >
        <span class="status-sep">│</span>
        <span class="line-total"
          >{{ editor_stats.currentLineCount }} lines</span
        >
