...
const blockArrowKeys = Prec.highest(
  keymap.of([
...
const extensions = computed(() => [
  lang_meta.currentLanguage.value === "js" ? javascript() : python(),
  vim(),
  blockArrowKeys,
]);
...
const handleStatistics = (s: Statistics) => {
  editor_stats.updateStatistics(s);
};
