...
@keyframes drift-b {
  ...
  65% {
    transform: translate(20px, 35px) scale(0.97);
  }
}
@keyframes drift-c {
  0%,
...
.dot-r {
  background: #c47060;
  box-shadow: 0 0 6px rgba(196, 112, 96, 0.5);
}
.dot-y {
  background: #c4a060;
...
.dot-g {
  background: #7aab2f;
  box-shadow: 0 0 6px rgba(122, 171, 47, 0.5);
}
